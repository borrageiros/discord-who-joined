...
INSERT INTO "new_WatcherConfig" ("channelFilterMode", "createdAt", "enabled", "guildId", "id", "locale", "messageTemplate", "notifyOnMove", "notifySelfJoin", "notifyWhileWatcherInVoice", "timezone", "updatedAt", "userId") SELECT "channelFilterMode", "createdAt", "enabled", "guildId", "id", "locale", "messageTemplate", "notifyOnMove", "notifySelfJoin", "notifyWhileWatcherInVoice", "timezone", "updatedAt", "userId" FROM "WatcherConfig";
